/**
 * HEIME - Shop Page JavaScript File
...
navLinks.forEach(link => {
    ...
    if (linkPage === currentPage || 
        (currentPage === 'shop.html' && linkPage.includes('shop.html'))) {
...
console.log('%cWelcome to HEIME - Shop Page! 👗', 'color: #FF6600; font-size: 20px; font-weight: bold;');
console.log('%cBrowse our complete collection of premium hoodies', 'color: #1a1a1a; font-size: 14px;');
